                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="jenis_kelamin" id="jenis_kelamin">
                                            <option value="l" <?php if($jk=='laki-laki'){ echo"selected"; } ?>>Laki Laki
                                            </option>
                                            <option value="p" <?php if($jk=='perempuan'){ echo"selected"; } ?>>Perempuan
                                            </option>
                                        </select>
                                    </td>
                                </tr>
